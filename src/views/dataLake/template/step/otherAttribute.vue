<template>
  <div id="otherAttributeBox">
    <div v-for="(item,index) in templateObj.nonInputProcessors" :key="index">
      ...
      <el-form class="properties-form" v-for="(properties,propertiesIdx) in item.properties">
        ...
        <div
          v-if="checkList.findIndex(el => (el == properties.propertyDescriptor.displayName)) != '-1'"
        >
          <el-form-item>
            <el-select
