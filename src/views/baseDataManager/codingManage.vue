<template>
    <section>
        <el-row :gutter="20">
            ...
            <!--创建术语表-->
            <el-dialog title="创建目录" :visible.sync="createGlossaryFormVisible" :close-on-click-modal="false">
            ...
            <!--创建类别-->
            <el-dialog title="修改目录" :visible.sync="createCagFormVisible" :close-on-click-modal="false">
            ...
            <!--创建实体-->
            <el-dialog title="创建编码标准" :visible.sync="createEntityFormVisible" :close-on-click-modal="false">
