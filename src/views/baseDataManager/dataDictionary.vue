<template>
    <section>
        <el-row :gutter="20">
            ...
            <el-col :span="18" v-show="standardNameId">
                <el-card class="box-card">
                    <div slot="header" class="clearfix">
                        <span>字典详情</span>
                    </div>
                        ...
                        <div >
                            ...
                            <el-table :data="allUser" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                                ...
                                <el-table-column  label="操作" min-width="150px">
                                    <template scope="scope">
                                        <el-button size="mini" title="编辑" plain type="primary" @click="editModelShow(scope.$index)"><i class="fa fa-edit"></i></el-button>
                                        <el-button size="mini" title="删除" plain type="danger" @click="remove2(scope.$index)"><i class="fa fa-trash"></i></el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
            ...
            <!--创建术语表-->
            <el-dialog title="创建字典" :visible.sync="createGlossaryFormVisible" :close-on-click-modal="false">
            ...
            <!--创建类别-->
            <el-dialog title="修改字典" :visible.sync="createCagFormVisible" :close-on-click-modal="false">
            ...
            <!--创建实体-->
            <!--创建实体-->
            <el-dialog title="创建数据字典明细" :visible.sync="createEntityFormVisible" :close-on-click-modal="false">
    ...
    export default {
        ...
        methods: {
            ...
            renderContent2(h, { node, data, store }) {
              ...
              <span >
              <el-button     style='font-size:12px' title='修改目录' type='text' on-click={ ()=>this.createCag(data.id,data.parentId,data.text)}><i class="el-icon-edit"></i></el-button>
              <el-button  style='font-size:12px' title='创建子目录' type='text' on-click={ ()=>this.creatGlossaryModal(data.id)}><i class="el-icon-circle-plus-outline"></i></el-button>
              <el-button   style='font-size:12px' title='删除目录' type='text' on-click={()=>this.deleteCag_(data.id)}><i class="el-icon-delete"></i></el-button>
