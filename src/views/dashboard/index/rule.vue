<template>
  <div id="ruleContainer">
    <div class="header">{{data.title}}（规则总个数：{{data.ruleInfo.data.ruleTotalCnt}}）</div>
    <div class="echarts-box">
      <div>
        <p>{{data.ruleInfo.title}}</p>
        <div :class="data.ruleInfo.className" v-loading="data.ruleInfo.loading"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    initData () {
      this.drawPie(this.data.ruleInfo)
    },
    /**
     * @description 饼图
