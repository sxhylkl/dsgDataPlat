            ...
            <el-table :data="list" v-loading="listLoading" border fit highlight-current-row style="width: 100%">
                ...
                <el-table-column width="120" align="center" label="状态">
                    <template slot-scope="scope">
                        ...
                        <el-tag v-else-if="scope.row.status ==='revoke'" type="danger">
                            <span>撤销</span>
                        </el-tag>
                    </template>
                </el-table-column>
...
<script>
    ...
    import { getApprovalHistory, getApproveDetail, getFlowImage } from '@/api/workflow/personOffice/event/flow.js'
    import { getApplyTask } from '@/api/workflow/personOffice/event/index'
